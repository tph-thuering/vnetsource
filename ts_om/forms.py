...
from .models import ExperimentFile, AnophelesSnippet, InterventionSnippet
from .models import DemographicsSnippet, BaselineScenario
...
class ScenarioDeploymentForm(forms.Form):
    ...
    timesteps = forms.CharField(initial=0)
    coverages = forms.CharField(initial=0.0)
