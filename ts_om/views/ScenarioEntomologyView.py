...
from ts_om.forms import ScenarioEntomologyForm, ScenarioEntomologyVectorForm
from ts_om.models import Scenario as ScenarioModel, AnophelesSnippet
from ts_om.views.ScenarioBaseFormView import ScenarioBaseFormView, update_form
...
class ScenarioEntomologyView(ScenarioBaseFormView):
    template_name = "ts_om/entomology.html"
