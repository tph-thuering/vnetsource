...
from ts_om.forms import ScenarioInterventionsForm, ScenarioGviInterventionForm, ScenarioLarvicidingInterventionForm, \
    ScenarioMdaInterventionForm, ScenarioVaccineInterventionForm, ScenarioImportedInfectionsForm
from ts_om.models import Scenario as ScenarioModel, InterventionSnippet
...
class ScenarioInterventionsView(ScenarioBaseFormView):
    template_name = "ts_om/interventions.html"
...
def update_interventions_form(request, scenario_id):
    ...
    html = render_to_string("ts_om/interventions/interventions_list.html", extra_data)
