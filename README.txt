Setting up development environment for VecNet-CI project

======== Windows 7 x64 ========
1. It is recommended to install Visual Studio 2008 Express Edition (python 2.7 was built using
2008 version)
http://www.microsoft.com/en-us/download/details.aspx?id=7873

2. Install libraries in VECNet/windows folder:
    GDAL 1.9 (Note: GDAL 1.10 doesn't with GeoDjango on Windows x64 for unknown reason)
    LXML 3.3.6
    Psycopg-2.5.4

If necessary, newer version can be downloaded on
http://www.gisinternals.com/sdk/PackageList.aspx?file=release-1500-x64-gdal-1-9-2-mapserver-6-2-0.zip
http://www.lfd.uci.edu/~gohlke/pythonlibs/#lxml
http://www.stickpeople.com/projects/python/win-psycopg/

If you get an error message like this: ImproperlyConfigured: Could not import user-defined GEOMETRY_BACKEND "geos".
then you may need to create a local settings file to accommodate this. The file should be called settings_local.py
inside of the VECNet folder. In this file type: GEOS_LIBRARY_PATH = "C:\\Program Files\\GDAL\\geos_c.dll"
...
depricated in EPEL repository and replaced with libarmadillo.so.4. Simply recompiling package should fix it, but this
...
if running on VM:
make sure that django.log file has proper permissions to write to.
======== Ubuntu ========
1. It is necesary to install development tools (gcc) first
...
======== MAC OS X ========
1. Use the "GDAL 1.11 Complete" installer from Kyng Chaos:
